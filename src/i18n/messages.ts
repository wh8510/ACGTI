...
export const messages = {
  'zh-CN': {
    ...
    home: {
      ...
      socialProof: {
        tag: 'Featured By',
        title: '超过 95 万人次访问，并被永雏塔菲直播游玩',
        copy: 'ACGTI 已累计获得超过 95 万访问人次，也曾出现在永雏塔菲的直播内容中。',
        pillA: '95W+ 累计访问',
        pillB: '永雏塔菲直播游玩',
        button: '观看直播录播',
        imageAlt: '永雏塔菲角色立绘',
  ...
  'zh-TW': {
    ...
    home: {
      ...
      stats: [
        { value: '950K+', label: '累計訪問人數', color: '#4899a3' },
      ...
      socialProof: {
        tag: 'Featured By',
        title: '累計超過 95 萬訪問，並曾由永雛塔菲直播遊玩',
        copy: 'ACGTI 已累計獲得超過 95 萬訪問人次，也曾出現在永雛塔菲的直播內容中。這些真實的傳播記錄，能讓首頁更直接地建立信任感與話題度。',
        pillA: '95W+ 累計訪問',
        pillB: '永雛塔菲直播遊玩',
        button: '觀看直播錄影',
        imageAlt: '永雛塔菲角色立繪',
